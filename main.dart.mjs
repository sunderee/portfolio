...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1629: x0 => x0.length,
      _1631: (x0,x1) => x0[x1],
      _1632: (x0,x1,x2) => x0[x1] = x2,
      _1635: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1637: x0 => new Int8Array(x0),
      _1638: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1639: x0 => new Uint8Array(x0),
      _1645: x0 => new Uint16Array(x0),
      _1647: x0 => new Int32Array(x0),
      _1649: x0 => new Uint32Array(x0),
      _1651: x0 => new Float32Array(x0),
      _1653: x0 => new Float64Array(x0),
      _1686: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1687: () => new TextDecoder("utf-8", {fatal: true}),
      _1688: () => new TextDecoder("utf-8", {fatal: false}),
      _1689: x0 => new WeakRef(x0),
      _1690: x0 => x0.deref(),
      _1696: Date.now,
      _1698: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1699: s => {
      ...
      _1701: () => typeof dartUseDateNowForTicks !== "undefined",
      _1702: () => 1000 * performance.now(),
      _1703: () => Date.now(),
      _1706: () => new WeakMap(),
      _1707: (map, o) => map.get(o),
      _1708: (map, o, v) => map.set(o, v),
      _1709: () => globalThis.WeakRef,
      _1719: s => JSON.stringify(s),
      _1720: s => printToConsole(s),
      _1721: a => a.join(''),
      _1722: (o, a, b) => o.replace(a, b),
      _1724: (s, t) => s.split(t),
      ...
      _1765: (t, s) => t.set(s),
      _1767: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1769: o => o.buffer,
      _1770: o => o.byteOffset,
      _1771: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1772: (b, o) => new DataView(b, o),
      _1773: (b, o, l) => new DataView(b, o, l),
      _1774: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1775: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1776: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1777: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1778: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1779: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1780: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1781: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1782: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1783: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1784: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1785: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1788: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1789: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1790: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1791: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1792: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1793: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1806: (o, t) => o instanceof t,
      ...
      _1810: o => Object.keys(o),
      _1811: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1812: (handle) => clearTimeout(handle),
      _1813: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1814: (handle) => clearInterval(handle),
      _1815: (c) =>
      ...
      _1863: (x0,x1) => x0.test(x1),
      _1864: (x0,x1) => x0.exec(x1),
      _1865: (x0,x1) => x0.exec(x1),
      _1866: x0 => x0.pop(),
      _1868: o => o === undefined,
      _1887: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1889: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1890: o => o instanceof RegExp,
      _1891: (l, r) => l === r,
      _1892: o => o,
      _1893: o => o,
      _1894: o => o,
      ...
      _1896: o => o.length,
      _1899: (o, i) => o[i],
      _1900: f => f.dartFunction,
      _1901: l => arrayFromDartList(Int8Array, l),
      _1902: l => arrayFromDartList(Uint8Array, l),
      _1903: l => arrayFromDartList(Uint8ClampedArray, l),
      _1904: l => arrayFromDartList(Int16Array, l),
      _1905: l => arrayFromDartList(Uint16Array, l),
      _1906: l => arrayFromDartList(Int32Array, l),
      _1907: l => arrayFromDartList(Uint32Array, l),
      _1908: l => arrayFromDartList(Float32Array, l),
      _1909: l => arrayFromDartList(Float64Array, l),
      _1910: x0 => new ArrayBuffer(x0),
      _1911: (data, length) => {
      ...
      _1912: l => arrayFromDartList(Array, l),
      _1913: (s, length) => {
        if (length == 0) return '';
      ...
      _1922: (o, p) => o[p],
      _1923: (o, p, v) => o[p] = v,
      _1924: (o, m, a) => o[m].apply(o, a),
      _1926: o => String(o),
      _1927: (p, s, f) => p.then(s, f),
      _1928: o => {
      ...
      _1933: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1963: x0 => x0.random(),
      _1964: x0 => x0.random(),
      _1968: () => globalThis.Math,
      _3840: () => globalThis.window,
      _4177: (x0,x1) => x0.href = x1,
      _6621: () => globalThis.document,
      _6702: x0 => x0.location,
